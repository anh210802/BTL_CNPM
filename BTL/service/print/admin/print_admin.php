...
if (!isset($_SESSION['username_admin']) && !isset($_SESSION['name_admin'])) {
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
      <div class="container">
        ...
        <a href="http://localhost/BTL/login/admin/menu_admin.php" class="navbar-brand">Quản lý dịch vụ</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar" style="padding-left: 4%;">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="http://localhost/BTL/login/admin/menu_admin.php" class="nav-link">Trang chủ</a>
            </li>
            <li class="nav-item">
              <a href="http://localhost/BTL/service/print/adminprint_admin.php" class="nav-link">Lưu lượng sử dụng</a>
            </li>
            <li class="nav-item">
        ...
        <form class="d-flex">
          <?php
            ...
            echo "<font color='WHITE'> " .$_SESSION['name_admin']. "</font>";
          ?>
        </form>
      </div>
    </nav>
              ...
              <div class="col-lg-12 col-md-6">
                ...
                <div class="list-group">
                  ...
                  <button
                    ...
                    class="list-group-item list-group-item-action"
                  >
                    <a href="http://localhost/BTL/service/print/admin/print_admin.php" class="nav-link">Máy in</a>
                  </button>
                  <button
                    type="button"
                    class="list-group-item list-group-item-action"
                  >
                    <a href="#" class="nav-link">Thuộc tính in</a>
                  </button>
                  <button
                    type="button"
                    class="list-group-item list-group-item-action"
                  >
                  <a href="#" class="nav-link">Trang in</a>
                  </button>
                  <button
                    type="button"
                    class="list-group-item list-group-item-action"
                  ...
                  <button
                    ...
                    class="list-group-item list-group-item-action"
                  >
                  <a href="#" class="nav-link">Liên hệ nhà phát triển</a>
                  </button>
                </div>
              </div>
              <div
          ...
          <div class="col-xl-8 col-lg-10" >
            <div class="container mt-2">
                ...
                <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="http://localhost/BTL/login/admin/menu_admin.php">Trang chủ</a></li>
                    <li class="breadcrumb-item"><a href="http://localhost/BTL/service/print/admin/print_admin.php">Máy in</a></li>
                    </ol>
                </nav>
                <!-- Product -->
                <div class="print_machine">
                  <div class="d-flex justify-content-end">
                      <form method="post" action="add_machine_print.php" class="add-print-machine-form">
                          <input type="submit" value="Thêm máy in">          
                      </form>
                      <form onclick="deletePrintMachine()" action="print_admin.php" method="post" class="delete-print-machine-form">
                          <input type="submit" value="Xóa máy in">          
                      </form>
                      <form onclick="editPrintMachine()" action="edit_machine_print.php" method="post" class="edit-print-machine-form">
    ...
    <script>
        $(document).ready(function() {
                  ...
                  success: function(data) {
                      ...
                      data.forEach(function(print_smart) {
                          var row = '<tr>' +
                              ...
                              '<td><label><input type="checkbox" id='+print_smart.id+' onclick="check(this)" ></label></td>' +
                              '</tr>';
          ...
          function addPrintMachine(){
            window.location.href = "add_print_machine.php";
          }

          function deletePrintMachine(){
            var data = {
                id: printId
            };
            // alert(data.id);
